...
let categoriesName = path.get("categoriesName");
let filteredCards = products.filter((el) => el.category === categoriesName);
let categoriesProducts = document.getElementById("cetegory-products")

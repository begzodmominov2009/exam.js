    ...
    discount_product.innerHTML += `  
     <div
                        ...
                        <div class="flex flex-col gap-[5px] sm:gap-[8px]  pt-[2px] sm:pt-[8px] ">
                            <p class="text-[14px] sm:text-[16px] px-[8px] line-clamp-2">${el.description}</p>
                            ...
                            <div class="px-[8px]">
                                <button
                                    class="w-full mb-[8px]  rounded-[4px] text-[#70C05B] px-[8px] hover:text-[white] duration-[0.5s] hover:bg-[#FF6633] hover:border-none cursor-pointer h-[35px] sm:h-[40px] border-[1px] border-[#70C05B]">
                                    В корзину
                                </button>
                            </div>
                            <span
